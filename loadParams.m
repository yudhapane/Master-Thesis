...
params.phi      = randn(params.NrbfX*params.NrbfY,1);    % actor parameters
...
params.alpha_a  = 0.08;                     % actor learning rate
params.alpha_c  = 0.5;                      % critic learning rate
params.gamma    = 0.90;                     % discount term
params.lambda   = 0.65;                     %  
